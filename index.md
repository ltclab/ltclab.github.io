...
<div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); margin-bottom: 40px;">
  ...
  <p style="color: #4b5563; font-size: 1.1rem; line-height: 1.7; text-align: left; margin-bottom: 0;">
    The lab was officially founded by Nate Ming Curran in 2025. The lab’s core mission is to promote interdisciplinary collaborative research at the intersection of language, technology, and culture. The lab seeks to conduct research that is theoretically grounded and has practical, real-world relevance. The majority of lab members are Dr. Curran’s current or former students. However, the lab also includes other researchers who frequently collaborate with the lab. Lab members conduct research in a mentorship model that prioritizes collegiality, curiosity, and collaboration.
  </p>
</div>
